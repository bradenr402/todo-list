...
function createDefaultTodos() {
  ...
  const trashTodo = new _todo__WEBPACK_IMPORTED_MODULE_0__.Todo({
    title: 'Take out trash',
    dueDate: yesterday,
  });

  const dishesTodo = new _todo__WEBPACK_IMPORTED_MODULE_0__.Todo({
    title: 'Wash dishes',
    description:
      'Empty dishwasher and put away clean dishes\nRinse dishes in sink\nLoad dirty dishes into dishwasher\nRerun clean cycle',
  });

  const laundryTodo = new _todo__WEBPACK_IMPORTED_MODULE_0__.Todo({
    title: 'Fold laundry',
    description: 'Fold and put away laundry in basket',
    dueDate: tomorrow,
  });

  const milkTodo = new _todo__WEBPACK_IMPORTED_MODULE_0__.Todo({
    title: 'Milk',
    list: 'Groceries',
  });

  const eggsTodo = new _todo__WEBPACK_IMPORTED_MODULE_0__.Todo({
    title: 'Eggs',
    list: 'Groceries',
  });

  const breadTodo = new _todo__WEBPACK_IMPORTED_MODULE_0__.Todo({
    title: 'Bread',
    list: 'Groceries',
  });

  const listOfLists = {};
  (0,_todo__WEBPACK_IMPORTED_MODULE_0__.addTodos)(listOfLists, trashTodo, dishesTodo, laundryTodo, milkTodo, eggsTodo, breadTodo);
